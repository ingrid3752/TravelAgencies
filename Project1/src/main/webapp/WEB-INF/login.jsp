...
<body>
    <div id="login-form">
      ...
      <p>&nbsp;<span style="color: rgb(255, 202, 104)">"로그인"</span> 하고 나만의</p><br>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: rgb(81, 151, 255);">"여행"</span>을 시작하세요</p><br><br><br>
          <div class="idid">
