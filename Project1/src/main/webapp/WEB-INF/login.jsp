  ...
  <body>
    <div id="login-form">
      <form action="/login" method="post">
        <div id="mainlogin">
          <img src="../IMG/로고.png" alt="" id="mainlogo" /><br /><br /><br />
          <p>
            &nbsp;<span style="color: rgb(255, 202, 104)">"로그인"</span> 하고
            나만의
          </p>
          <br />
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
              style="color: rgb(81, 151, 255)"
              >"여행"</span
            >을 시작하세요
          </p>
          <br /><br /><br />
