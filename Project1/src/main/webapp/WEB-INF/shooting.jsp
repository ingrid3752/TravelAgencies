      ...
      <div class="ticket">
        ...
        <div class="ticket-info">
          <div class="text-wrapper">
            <!-- 텍스트 내용 -->
					<span class="text"> 스포츠로서의 사격의 역사는 총의 발명과 그 역사를 같이 한다고 할 수
						있다. 그러나 오늘날 올림픽 종목으로서의 국제적인 스포츠 사격의 역사는, 1896년 제1회 아테네 올림픽에서 사격이
						정식 종목으로 채택되고 1907년 국제사격연맹이 설립된 이후부터라 할 수 있을 것이다. </span> <span class="more-text">더보기</span>
