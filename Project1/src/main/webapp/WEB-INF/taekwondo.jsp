...
<%@ include file="./header.jsp" %>
 <div class="ticket-container">
      <div class="ticket">
        ...
        <div class="ticket-info">
          <div class="text-wrapper">
            <!-- 텍스트 내용 -->
            <span class="text"
              >태권도는 대한민국에서 1950년대에 창안되고 발전한 현대 무술로, 대한민국의 국기이다.발차기를 중심으로 손과 발 및 기타 신체부위를 이용해서 상대를 효과적으로 제압하는 것을 지향한다. 한국에서 매년 9월 4일은 기념일인 '태권도의 날'로 지정되어 있다. 전세계적인 규정으로 경기 진행에서 한국어를 사용한다.</span
            >
        ...
        <img src="../IMG/태권도.png" alt="이미지" id="imgbask" />
      </div>
    </div>
    <!--------------------------------------------------------------------------->
    <div class="ticket-container6">
      <div class="ticket6">
        <div id="modaldiv">
          <img src="../IMG/태권도마스코트.png" alt="이미지" id="imgbask" />
        </div>
        <div class="ticket-info">
          <a href="https://www.worldtaekwondo.org/index.html"><img src="../IMG/태권도주관단체.png" alt="이미지" id="imgbask" /></a>
        </div>
        <div class="ticket-icon"></div>
      </div>
